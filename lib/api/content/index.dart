...
class ApiContentIndex {
  ...
  /// 拉取用户内容推荐帖子列表
    ...
    if (lastId != null) {
      List<ContentDetailStruct> dataList = [
        ContentDetailStruct(
          '2001',
          '我是第二页数据',
          '第二页拿来测试的数据',
      ...
      return StructApiContentListRetInfo(0, 'success', false, '2001', dataList);
    } else {
      List<ContentDetailStruct> dataList = [
        ContentDetailStruct(
          '1001',
      ...
      return StructApiContentListRetInfo(0, 'success', true, '1010', dataList);
    }
  }

  /// 拉取用户关注的帖子列表
  List<ContentDetailStruct> getFollowList() {
    return [
      ContentDetailStruct(
        '1001',
        '长相思·一重山',
