...
class ImgCard extends StatelessWidget {
  ...
  /// 传入的帖子列表信息
  final List<ContentDetailStruct> articleInfoList;
  ...
  Widget withSmallPic(BuildContext context)  {
    ...
    for (var i = 0; i < 3; i ++) {
      ...
      ContentDetailStruct articleInfo = articleInfoList[i];
      rowList.add(Expanded(
        flex: 2,
  ...
  /// 获取具体的图片组件
  Widget getFlatImg(BuildContext context, ContentDetailStruct articleInfo,
      [double size = 100]) {
    return FlatButton(
